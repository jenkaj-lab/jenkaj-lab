...
# Configuration
For this configuration I am using Ubuntu Server 24.04.2 LTS for the C2 server and gateway, and Arch Linux for the infected machine. You don't need to use Arch for your infected machine, you can use whatever Linux distribution you're comfortable with. I recommend Ubuntu Server for the C2 machine because it offers easy-to-install DNS software from the package repository, and is very beginner friendly. In my case these are setup as Virtual Machines (VMs) using VirtualBox, which removes the need for additional hardware and simplifies networking. Use whatever virtualization technology you're comfortable with to setup those three machines, then continue reading to begin configuring your server.
